...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_RAW_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Completed (9) If the savedInstanceState bundle is not null,
        // set the text of the URL and search results TextView respectively
        if (savedInstanceState != null) {
            String queryUrl = savedInstanceState.getString(KEY_QUERY);
            String rawJsonResults = savedInstanceState.getString(KEY_RAW_JSON);
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putString(KEY_QUERY, queryUrl);
