...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // Completed (8) Add a private static int called viewHolderCount that will hold the total
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        // Completed (13) Use ColorUtils.getViewHolderBackgroundColorFromInstance and pass
        // in a Context and the viewHolderCount
        int backGroundColor = ColorUtils.getViewHolderBackgroundColorFromInstance(
                context, viewHolderCount);
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        public NumberViewHolder(View itemView) {
            ...
            viewHolderIndex = (TextView)itemView.findViewById(R.id.tv_view_number_holder_instance);
        }
